...
namespace SADI.KEPlugin
{
    class SemWebVocab
    {
        ...
        public const string SADI = "http://sadiframework.org/ontologies/sadi.owl#";

        public static readonly Entity rdf_type = RDF + "type";
        public static readonly Entity rdfs_label = RDFS + "label";
        ...
        public static readonly Entity unbound = SADI + "_unbound";
